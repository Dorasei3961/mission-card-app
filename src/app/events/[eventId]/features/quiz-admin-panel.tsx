...
export function QuizAdminPanel({ eventId }: Props) {
  ...
  const createQuiz = async () => {
    ...
    try {
      ...
      const ref = doc(db, "events", eventId, "quizzes", id);
      await setDoc(ref, {
        question: qText.trim(),
        choices,
        correctIndex,
          ...
          <section className="rounded-2xl border border-violet-100 bg-white p-4 shadow-sm">
            ...
            <div className="mt-3 space-y-2">
              ...
              <button
                ...
                className="w-full rounded-xl border border-violet-200 bg-violet-50 py-2.5 text-sm font-bold text-[#7C3AED] shadow-sm disabled:opacity-50 touch-manipulation"
              >
                下書きとして保存
              </button>
            </div>
            ...
            <section className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-4 shadow-sm">
              ...
              <div className="mt-4 grid grid-cols-3 gap-2">
                <div className="rounded-xl bg-white px-2 py-2 text-center shadow-sm ring-1 ring-emerald-100">
                  ...
                  <p className="mt-1 text-[10px] font-semibold text-zinc-500">回答者数</p>
                ...
                <div className="rounded-xl bg-white px-2 py-2 text-center shadow-sm ring-1 ring-emerald-100">
                  ...
                  <p className="mt-1 text-[10px] font-semibold text-zinc-500">正解者数</p>
  ...
  return (
    <li className="rounded-xl border border-zinc-100 bg-zinc-50/60 px-3 py-2">
      ...
      <p className="mt-1 text-[11px] text-zinc-600">
        回答 {stats.total}人 · 正解 {stats.correct}人 · 正解率 {rate}%
      </p>
    </li>
  );
}
